...
function newFunction() {
  const modalViews = document.querySelectorAll(".cv-modal"), modalBtns = document.querySelectorAll(".cv-button"), modalCloses = document.querySelectorAll(".cv-modal-close");
